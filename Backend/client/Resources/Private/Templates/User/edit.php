<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Konto</h1>
            <div id="delete-confirm" title="Konto löschen">
            ...
            <form id="delete-form" action="<?php echo $this->base_url?>/user/destroy" method="POST" style="display: none;">
            </form>
            <form class="form-horizontal" method="POST" action="<?php echo $this->base_url?>/user/update">
                ...
                <div class="form-group<?php echo isset($data['error']['username']) ? ' has-error' : '' ?>">
                    ...
                    <div class="col-md-4">
                        <input id="username" type="text" class="form-control" name="username" value="<?php echo (isset($data['input_data']['username'])?$data['input_data']['username']:''); ?>" required autofocus>
                ...
                <div class="form-group<?php echo isset($data['error']['firstname']) ? ' has-error' : '' ?>">
                    <label for="firstname" class="col-md-2 control-label">Vorname *</label>

                    <div class="col-md-4">
                        <input id="firstname" type="text" class="form-control" name="firstname" value="<?php echo (isset($data['input_data']['firstname'])?$data['input_data']['firstname']:''); ?>" required>
                ...
                <div class="form-group<?php echo isset($data['error']['name']) ? ' has-error' : '' ?>">
                    <label for="name" class="col-md-2 control-label">Nachname *</label>

                    <div class="col-md-4">
                        <input id="name" type="text" class="form-control" name="name" value="<?php echo (isset($data['input_data']['name'])?$data['input_data']['name']:''); ?>" required>
                ...
                <div class="form-group<?php echo isset($data['error']['address']) ? ' has-error' : '' ?>">
                    ...
                    <div class="col-md-4">
                        <input id="address" type="text" class="form-control" name="address" value="<?php echo (isset($data['input_data']['address'])?$data['input_data']['address']:''); ?>">
                ...
                <div class="form-group<?php echo isset($data['error']['zip']) ? ' has-error' : '' ?>">
                    <label for="zip" class="col-md-2 control-label">PLZ</label>

                    <div class="col-md-4">
                        <input id="zip" type="text" class="form-control" name="zip" value="<?php echo (isset($data['input_data']['zip'])?$data['input_data']['zip']:''); ?>" >
                ...
                <div class="form-group<?php echo isset($data['error']['city']) ? ' has-error' : '' ?>">
                    <label for="city" class="col-md-2 control-label">Ort</label>

                    <div class="col-md-4">
                        <input id="city" type="text" class="form-control" name="city" value="<?php echo (isset($data['input_data']['city'])?$data['input_data']['city']:''); ?>">
                ...
                <div class="form-group<?php echo isset($data['error']['phone']) ? ' has-error' : '' ?>">
                    ...
                    <div class="col-md-4">
                        <input id="phone" type="text" class="form-control" name="phone" value="<?php echo (isset($data['input_data']['phone'])?$data['input_data']['phone']:''); ?>">
                ...
                <div class="form-group<?php echo isset($data['error']['email']) ? ' has-error' : '' ?>">
                    ...
                    <div class="col-md-4">
                        <input id="email" type="email" class="form-control" name="email" value="<?php echo (isset($data['input_data']['email'])?$data['input_data']['email']:''); ?>" disabled required>
                ...
                <div class="form-group<?php echo isset($data['error']['email']) ? ' has-error' : '' ?>">
                    <label for="coordinates" class="col-md-2 control-label">Koordinaten</label>
                ...
                <div class="form-group">
                    <label for="password_confirm" class="col-md-2 control-label">Passwort wiederholen</label>

                    <div class="col-md-4">
                        <input id="password_confirm" type="password" class="form-control" name="password_confirm" value="<?php echo (isset($data['input_data']['password_confirm'])?$data['input_data']['password_confirm']:''); ?>">
                    </div>
                </div>
